...
class TelegramAlerter:
    def __init__(self, bot_token: str, chat_id: str, venue_label: str = "Binance"):
        self._url = f"https://api.telegram.org/bot{bot_token}/sendMessage"
        self._chat_id = chat_id
        # Prefixes every message with the venue (Binance vs OKX run in parallel into
        # the same Telegram chat). This is the live src/ bot, so it defaults to Binance.
